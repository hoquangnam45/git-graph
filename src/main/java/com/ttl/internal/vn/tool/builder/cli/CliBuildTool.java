            ...
            public boolean start() {
                ...
                for (DiffEntry diffEntry : buildCtx.getDiffEntries()) {
                    switch (diffEntry.getChangeType()) {
                        case DELETE: {
                            String moduleRelativePath = getModuleFromRelativePath(diffEntry.getOldPath(), leafModuleRelativePaths);
                            moduleToDeletedEntriesMap.computeIfAbsent(moduleRelativePath, k -> new ArrayList<>()).add(diffEntry);
                            break;
                        }
                        case MODIFY:
                        case COPY:
                        case ADD: {
                            String moduleRelativePath = getModuleFromRelativePath(diffEntry.getNewPath(), leafModuleRelativePaths);
                            moduleToChangedEntriesMap.computeIfAbsent(moduleRelativePath, k -> new ArrayList<>()).add(diffEntry);
                            break;
                        }
                        case RENAME: {
                            String deletedModuleRelativePath = getModuleFromRelativePath(diffEntry.getOldPath(), leafModuleRelativePaths);
                            moduleToDeletedEntriesMap.computeIfAbsent(deletedModuleRelativePath, k -> new ArrayList<>()).add(diffEntry);
                            String modifyModuleRelativePath = getModuleFromRelativePath(diffEntry.getNewPath(), leafModuleRelativePaths);
                            moduleToChangedEntriesMap.computeIfAbsent(modifyModuleRelativePath, k -> new ArrayList<>()).add(diffEntry);
                            break;
                        }
                        default:
